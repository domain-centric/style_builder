[//]: # (This file was generated from: doc/template/doc/wiki/6-Generated-style-classes.md.template using the documentation_builder package)

The generated style classes will be placed in the same directory as the annotated class and will look something like this:

`example/lib/my_company.g.dart`
```dart
